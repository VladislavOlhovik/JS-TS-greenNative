...
import { getStreetsTitlesOfGovernmentsBuildings, getStreetsTitlesOfHouses, createMessages } from "./05_02";
...
test('List of streets titles of goverments buildings',()=>{
    let streetsName = getStreetsTitlesOfGovernmentsBuildings(
...
test('create greeting messages for srteets',()=>{
